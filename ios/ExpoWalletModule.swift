...
public class ExpoWalletModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    Events(
      "onPassAdded", "onPassUpdated", "onPassRemoved", "onWalletAvailabilityChanged", "onChange")
    ...
    AsyncFunction("isWalletAvailable") { () -> [String: Any] in
      ...
      let canAddPasses = await MainActor.run {
    ...
    AsyncFunction("addPKSecureElementPass") { (passData: [String: Any]) -> [String: Any] in
      if #available(iOS 13.0, *) {
        ...
        return [
          "success": false,
          "error": "PKSecureElementPass requires iOS 13.0 or later",
        ]
      }
    }

    AsyncFunction("updatePKSecureElementPass") {
      (passId: String, passData: [String: Any]) -> [String: Any] in
      if #available(iOS 13.0, *) {
    ...
    AsyncFunction("addPKStoredValuePass") { (passData: [String: Any]) -> [String: Any] in
      if #available(iOS 14.0, *) {
        ...
        return [
          "success": false,
          "error": "PKStoredValuePass requires iOS 14.0 or later",
        ]
      }
    }

    AsyncFunction("updatePKStoredValuePass") {
      (passId: String, passData: [String: Any]) -> [String: Any] in
      if #available(iOS 14.0, *) {
    ...
    AsyncFunction("updateStoredValueBalance") {
      (passId: String, newBalance: Double) -> [String: Any] in
      if #available(iOS 14.0, *) {
    ...
    AsyncFunction("addPKIdentityDocument") { (passData: [String: Any]) -> [String: Any] in
      if #available(iOS 15.0, *) {
        ...
        return [
          "success": false,
          "error": "PKIdentityDocument requires iOS 15.0 or later",
        ]
      }
    }

    AsyncFunction("updatePKIdentityDocument") {
      (passId: String, passData: [String: Any]) -> [String: Any] in
      if #available(iOS 15.0, *) {
    ...
    AsyncFunction("addPKShareablePass") { (passData: [String: Any]) -> [String: Any] in
      if #available(iOS 16.0, *) {
        ...
        return [
          "success": false,
          "error": "PKShareablePass requires iOS 16.0 or later",
        ]
      }
    }

    AsyncFunction("updatePKShareablePass") {
      (passId: String, passData: [String: Any]) -> [String: Any] in
      if #available(iOS 16.0, *) {
    ...
    AsyncFunction("sharePKPass") { (passId: String, recipients: [String]) -> [String: Any] in
      if #available(iOS 16.0, *) {
        ...
        return [
          "success": false,
          "error": "Pass sharing requires iOS 16.0 or later",
        ]
      }
    }
    ...
    AsyncFunction("addToGoogleWallet") {
      (classData: [String: Any], objectData: [String: Any]) -> [String: Any] in
      return [
        "success": false,
        "error": "Google Wallet is not available on iOS",
      ]
    ...
    AsyncFunction("updateGoogleWalletObject") {
      (objectId: String, objectData: [String: Any]) -> [String: Any] in
      return [
        "success": false,
        "error": "Google Wallet is not available on iOS",
      ]
    ...
    AsyncFunction("getAllPasses") { () -> [String: Any] in
      let walletPasses = self.passLibrary.passes()
      let passInfo = walletPasses.map { pass in
        return [
    ...
    AsyncFunction("createNFCSecureElementCredential") {
      (credentialData: [String: Any]) -> [String: Any] in
      if #available(iOS 18.1, *) {
  ...
  private func createPKIdentityDocument(from passData: [String: Any]) async -> [String: Any] {
    ...
    return [
      "success": false,
      "error":
        "PKIdentityDocument requires special entitlements and is not available for general use",
    ]
  }
  ...
  private func addPassToLibrary(_ pass: PKPass) async -> [String: Any] {
    ...
    if canAddPasses {
      ...
      return [
        "success": false,
        "error": "Cannot add passes to library",
      ]
    }
  }
  ...
  private func createPassDictionary(from passData: [String: Any]) throws -> [String: Any] {
    guard let passTypeIdentifier = passData["passTypeIdentifier"] as? String,
      ...
      let passStyle = passData["passStyle"] as? String
    else {
      throw NSError(
        domain: "ExpoWallet", code: 2,
        userInfo: [NSLocalizedDescriptionKey: "Missing required pass data"])
    }
    ...
    if let headerFields = passData["headerFields"] as? [[String: Any]] {
      dict[passStyle] = (dict[passStyle] as! [String: Any]).merging(["headerFields": headerFields])
      { _, new in new }
    }

    if let primaryFields = passData["primaryFields"] as? [[String: Any]] {
      dict[passStyle] = (dict[passStyle] as! [String: Any]).merging(["primaryFields": primaryFields]
      ) { _, new in new }
    }

    if let secondaryFields = passData["secondaryFields"] as? [[String: Any]] {
      dict[passStyle] = (dict[passStyle] as! [String: Any]).merging([
  ...
  @available(iOS 13.0, *)
  private func createSecureElementPassDictionary(from passData: [String: Any]) throws -> [String:
    Any]
  {
  ...
  private func updateSecureElementPass(passId: String, passData: [String: Any]) async -> [String:
    Any]
  {
    return [
      "success": false,
  ...
  private func updateIdentityDocument(passId: String, passData: [String: Any]) async -> [String:
    Any]
  {
    return [
      "success": false,
